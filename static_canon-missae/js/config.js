...
window.SITE_CONFIG = (function () {
    ...
    const productionRoots = {
        'https://canon-missae.ispan.pl': 'https://canon-missae.ispan.pl',
        'http://canon-missae.ispan.pl': 'https://canon-missae.ispan.pl',
    };

    return {
        pageRoot: productionRoots[origin] || origin,
        projectId: 4,
        siteName: 'Canon Missae',
