...
REPO_URL=https://github.com/TutajITeraz/eCatalogus.git
GIT_BRANCH=main
...
def main() -> int:
    ...
    logo_target = overlay_dir / 'img' / 'logo_flat.svg'
    if not logo_target.exists() or args.dry_run:
        copy_file(BASE_LOGO_PATH, logo_target, args.dry_run)
    else:
        print(f'[skip] logo already exists at {logo_target.relative_to(REPO_ROOT)}')
