// Instance config — Corpus Liturgicum
...
window.SITE_CONFIG = (function () {
    ...
    const productionRoots = {
        'https://corpus-liturgicum.org': 'https://corpus-liturgicum.org',
        'http://corpus-liturgicum.org': 'https://corpus-liturgicum.org',
    };

    return {
        pageRoot: productionRoots[origin] || origin,
        projectId: 5,
        siteName: 'Corpus Liturgicum',
